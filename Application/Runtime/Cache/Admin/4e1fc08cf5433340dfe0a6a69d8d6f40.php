...
<!-- /Page Sidebar -->
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    <li>
                        <a href="/shop/index.php/Admin/brand/lst">系统</a>
                    </li>
                    <li>
                        <a href="/shop/index.php/Admin/brand/lst">品牌管理</a>
                    </li>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="/shop/index.php/Admin/Brand/edit" enctype="multipart/form-data" method="post">
                                        <input type="hidden" name="id" id="id" value="<?php echo ($id); ?>">
                                        <div class="form-group">
                                            <label for="brand_name"
                                                   class="col-sm-2 control-label no-padding-right">品牌名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="brand_name" placeholder="" name="brand_name"
                                                       required="" type="text" value="<?php echo ($brandname); ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="file" id="brand_logo" name="brand_logo" value="<?php echo ($brand_logo); ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label no-padding-right">品牌地址</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" id="brand_url" name="brand_url"
                                                       required="" type="text" value="<?php echo ($brand_url); ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
