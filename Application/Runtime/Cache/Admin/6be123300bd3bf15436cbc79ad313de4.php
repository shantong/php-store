        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '/shop/index.php/Admin/Brand/add'"><i class="fa fa-plus"></i>
                    Add
                </button>
                <div class="row">
                            ...
                            <div class="widget-body">
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                        <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$brand): $mod = ($i % 2 );++$i;?><tr>
                                                <td align="center"><?php echo ($brand["brand_name"]); ?></td>
                                                <td align="center"><img src="/shop/<?php echo ($brand["brand_logo"]); ?>" height="50px "/></td>
                                                <td align="center"><?php echo ($brand["brand_url"]); ?></td>
                                                <td align="center">
                                                    <a href="/shop/index.php/Admin/Brand/edit/id/<?php echo ($brand["id"]); ?>/brandname/<?php echo ($brand["brand_name"]); ?>/brand_url/<?php echo ($brand["brand_url"]); ?>"
                                                       class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="#" onClick="warning('确实要删除吗', '/shop/index.php/Admin/Brand/del/id/<?php echo ($brand["id"]); ?>')" class="btn btn-danger btn-sm shiny">
