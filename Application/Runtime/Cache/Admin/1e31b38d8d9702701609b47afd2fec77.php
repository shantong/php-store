        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '/shop/index.php/Admin/Cate/add'"><i class="fa fa-plus"></i>
                    Add
                </button>
                <div class="row">
                            ...
                            <div class="widget-body">
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><tr>
                                                <td align="center"><?php echo ($cate["id"]); ?></td>
                                                <td align="center"><?php echo ($cate["catename"]); ?></td>
                                                <td align="center">
                                                    <a href="/shop/index.php/Admin/Cate/edit/id/<?php echo ($cate["id"]); ?>/catename/<?php echo ($cate["catename"]); ?>"
                                                       class="btn btn-primary btn-sm shiny">
                                                        <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                    <a href="#" onClick="warning('确实要删除吗', '/shop/index.php/Admin/Cate/del/id/<?php echo ($cate["id"]); ?>')" class="btn btn-danger btn-sm shiny">
